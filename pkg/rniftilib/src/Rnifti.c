...
SEXP Rnifti_image_getpixel(SEXP nim, SEXP sexp_x, SEXP sexp_y, 
...
SEXP Rnifti_image_setpixel(SEXP nim, SEXP sexp_x, SEXP sexp_y, 
			   SEXP sexp_z, SEXP sexp_t, SEXP value)
{
  SEXP ret_val=R_NilValue;
  nifti_image *pnim=SEXP2NIFTI(nim);
